  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-semibold text-xl">Party Palace Booking Details</p>
        <div className="mt-4 flex flex-col gap-4">
          ...
          <div className=" h-[calc(100vh-64px)] flex flex-col gap-4 overflow-y-scroll ">
            <div className=" h-[calc(50vh-64px)] flex flex-col gap-4 overflow-y-scroll ">
              {bookingData?.map((el, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {/* toggle section for cameramen and partyplace  */}
            ...
            <div className="h-[calc(50vh-64px)] flex flex-col gap-4 overflow-y-scroll">
              <p className="font-semibold text-xl">Cameramen Booking Details</p>
            </div>
          </div>
        </div>
      </div>
