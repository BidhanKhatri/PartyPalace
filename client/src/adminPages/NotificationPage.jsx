...
const NotificationPage = () => {
  const { getMyPartyPalace, myPartyPalaceData } = useContext(adminContext);
        ...
        {location.pathname === "/admin/booking-userstatus" && (
          <div className="flex flex-col gap-4">
            {myPartyPalaceData.length > 0 ? (
                ...
                >
                  <div className="py-2 px-4">
                    <img
                      src={palace.images[0]}
                      alt={palace.name}
                      className="w-32 h-32 object-cover rounded-md border text-xs flex items-center justify-center text-center"
                    />
                  </div>
                  ...
                  <div className="py-2 px-4 ">
                    ...
                    >
                      View
                      <span className="absolute -top-2 right-0 bg-red-500 text-white size-5 rounded-full p-1 text-xs flex items-center justify-center text-center">
                        0
                      </span>
                    </button>
                  </div>
              ...
              <div>
                <div colSpan="3" className="text-center py-4 text-gray-500">
